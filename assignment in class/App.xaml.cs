...
using $safeprojectname$.ApplicationModel;
using $safeprojectname$.ApplicationModel.Activation;
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                rootFrame.Language = $safeprojectname$.Globalization.ApplicationLanguages.Languages[0];
